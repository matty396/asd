        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
                <div class="card-body"> 
                  <form class="row g-3" action="{{url('compra')}}" method="post" id="addcompra" enctype="multipart/form-data">
                  ...
                  <form class="row g-3" action="{{url('compraDetalle')}}" method="post" id="addcompraDetalle" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="compra_id" id="compra_id" value="{{isset($compra_id)}}">
                    <input type="hidden" name="proveedor_id" id="proveedor_id" value="{{isset($proveedor_id)}}">
