...
@section('content')
    ...
    <h4>Administracion de Datos Personales</h4>
        ...
        <table class="table table-light table-hover">
            ...
            @foreach($personas as $item)
                <tr>
                    ...
                    <td>{{ $item->celular }}</td>
                    <td>
                        <a href="{{url('persona/'.$item->id.'/edit')}}" title="Editar registro"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
